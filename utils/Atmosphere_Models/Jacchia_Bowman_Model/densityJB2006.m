function [TEMP, RHO] = densityJB2006(long,lat,alt,year,doy)
% Usage: [~, rho] = densityJB2006(long,lat,alt,year,doy)
%
% Adapted by Garrett Ailts from test_JB2006.m written by M. Mahooti
